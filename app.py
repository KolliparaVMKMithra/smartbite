...
# Add Azure Cognitive Search configuration
AZURE_SEARCH_ENDPOINT = os.environ.get("AZURE_SEARCH_ENDPOINT", "https://your-search-service.search.windows.net")
AZURE_SEARCH_KEY = os.environ.get("AZURE_SEARCH_KEY", "eu4QKRAAKYisuihUv6W8HivhHsBhQCd9gRZuUE1L2fAzSeBUCs8B")
...
# Add a new route to get recipes
...
app.config['MAIL_USERNAME'] = 'macherlasaimani@gmail.com' # Replace with your email
app.config['MAIL_PASSWORD'] = 'pgxyemusugognilr' # Replace with your password
app.config['MAIL_DEFAULT_SENDER'] = 'macherlasaimani@gmail.com' # Replace with your email
...
AZURE_ENDPOINT = os.environ.get("AZURE_VISION_ENDPOINT", "https://recipe.cognitiveservices.azure.com/")
AZURE_KEY = os.environ.get("AZURE_VISION_KEY", "F2hRrnFfpZfOxXaryoXYqGJ4DJrJrvLkdshzIiH7NyyncscRm0ATJQQJ99BCAC8vTInXJ3w3AAAFACOGSjsd")
...
# Generic date pattern for dates without labels
